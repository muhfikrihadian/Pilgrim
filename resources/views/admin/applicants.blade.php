  ...
  <div class="row">
    ...
    <div class="col l9 s12">
      <div class="row margintopdp">
        <form class="col s12" action="{{ route('admin.applicants.search') }}" method="POST">
          {{ csrf_field() }}
          <div class="row">
        ...
        @foreach($jobSeeker as $seeker)
          <li>
            <div class="collapsible-header">
              ...
              <a class="usersname" href="index.html"> {{ $seeker->first_name." ".$seeker->last_name }}</a>
            </div>
            <div class="collapsible-body">          
              <a class="waves-effect waves-light btn" href="{{ route('admin.applicant.profile', ['email' => $seeker->email]) }}">LIHAT</a>
