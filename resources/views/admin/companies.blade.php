  ...
  <div class="row">
    ...
    <div class="col l9 s12">
      <div class="row margintopdp">
        <form class="col s12" action="{{ route('admin.companies.search') }}" method="POST">
          {{ csrf_field() }}
          <div class="row">
          ...
          @foreach($companies as $companie)
            <li>
              <div class="collapsible-header">
                <img src="{{ url('image/company/'.$companie->banner_image) }}" alt="" class="circle responsive-img usersavatar">
                <a class="usersname" href="index.html"> {{ $companie->company_name}}</a>
              </div>
              <div class="collapsible-body">          
                <a class="waves-effect waves-light btn" href="#">LIHAT</a>
